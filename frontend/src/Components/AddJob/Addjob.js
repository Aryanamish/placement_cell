...
const Addjob = () => {
    ...
    const save_change = async (event)=>{
        ...
        let data = await instance.post('jobs/save/', bodyFormData);
        navigate('/job/edit/' + data.data.slug);
        console.log(data);
    }
  ...
  return (
    <div className='container'>
        ...
        <input type={'button'} value={'Save'} className={'btn btn-success'} onClick={save_change}/>
    </div>
  )
}
